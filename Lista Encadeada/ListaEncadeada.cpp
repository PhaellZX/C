...
int main(){
	...
	*/
	...
	// Exercicio 4 - Selecionar remover da Lista Obs:(quando remove o ultimo valor está imprimindo lixo de memória infinitamente:()
	...
	/* Exercicio 5 - Inserir no inicio usando void obs:(Não utilizei ponteiro do ponteiro e mesmo assim deu certo)
